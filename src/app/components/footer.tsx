          ...
          <div className="text-center md:text-left">
            ...
            <nav>
              <ul className="space-y-4 underline">
                ...
                <li><Link href="#" className="hover:text-zinc-600">Solicitar Autorização Eletrônica de Viagem</Link></li>
                <li><Link href="#" className="hover:text-zinc-600">Acompanhar Autorização Eletrônica de Viagem</Link></li>
                <li><Link href="#" className="hover:text-zinc-600">Contato</Link></li>
              </ul>
            </nav>
          </div>
          <div className="text-center md:text-left">
            ...
            <nav>
              <ul className="space-y-4 underline">
                <li><Link href="#" className="hover:text-zinc-600">Artigos</Link></li>
                <li><Link href="#" className="hover:text-zinc-600">Certificado Cadastur</Link></li>
                <li><Link href="#" className="hover:text-zinc-600">Política de Privacidade</Link></li>
                <li><Link href="#" className="hover:text-zinc-600">Termos e Condições</Link></li>
              </ul>
            </nav>
          </div>
          <div>
